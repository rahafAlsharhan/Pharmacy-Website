...
<html>
    <head>
        ...
        <link rel="stylesheet" href="admiin.css">
  ...
  <header>
        ...
        <div class="icons">
        <a href="Lucid.html" class="fas fa-shopping-cart"></a>
        <a href="admiin.html" class="fas fa-user"></a>
        </div>
        ...
        <section class="head"> 
            <p> about us  <span>.</span></p><br>
            <p> lucid shop 
        were u can find All skin and beauty products at the best prices and high quality</p>
             <br>   
        <br>
        <br>    
